...
static void clearram() {
	...
	// unlike Nexus 6P.
/* process of elimination: it's in the last region
for (int* p = (int*)0x81000000ull; p <= (int*)0x856fffffull; p++){ *p=0xff00ff00; }
for (int* p = (int*)0x85d00000ull; p <= (int*)0x85dfffffull; p++){ *p=0xff00ff00; }
for (int* p = (int*)0x85f00000ull; p <= (int*)0x85fbffffull; p++){ *p=0xff00ff00; }
for (int* p = (int*)0x88f00000ull; p <= (int*)0x8aafffffull; p++){ *p=0xff00ff00; }
for (int* p = (int*)0x8c417000ull; p <= (int*)0x8c4fffffull; p++){ *p=0xff00ff00; }
*/
for (int* p = (int*)0x99c00000ull; p <= (int*)0xa17fffffull; p++){ *p=0xff00ff00; }
